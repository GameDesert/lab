        ...
        .then(function(response) {
            if (response.query.searchinfo.totalhits != 0){
                ...
                for (let resultcount = 0; resultcount < response.query.searchinfo.totalhits; resultcount++) {
                    var wikiresultentry = "<li style='cursor: pointer;' onclick='loadWikiPage(" + response.query.search[resultcount].pageid + ", `" + response.query.search[resultcount].title + "`);'>" + response.query.search[resultcount].title + "</li>"
